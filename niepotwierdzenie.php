...
$sql2=@$polaczenie->query("INSERT INTO rezerwacje (id, data_odbioru, data_rezerwacji, id_osoba, id_status, id_egzemplarza) VALUES (NULL, CURDATE() + INTERVAL 3 DAY, CURDATE(), $id_osoby, 7, $id_egzemplarza)");

header('Location: wyszukiwanie.php', true, 303);
 ?>
